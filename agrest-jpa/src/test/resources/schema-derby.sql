...
CREATE TABLE e35 (e2_id INTEGER, address VARCHAR (255), id INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY, name VARCHAR (100), PRIMARY KEY (id))
;

CREATE TABLE e36 (e35_id INTEGER  , id INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY , name VARCHAR (200), phone_number VARCHAR (12), PRIMARY KEY (id))
;
